    ...
    response = client.chat.completions.create(
        ...
        messages=[{
            ...
            "content": (
                ...
                "- The aggressor has a speech bubble that says EXACTLY: \"GET OUT OF THE BALLS EVAN\"\n"
                "- The victim has a speech bubble that says EXACTLY: \"MY PRODUCTIVITY\"\n\n"
                ...
                "The speech bubbles must be clearly legible with the exact text above. "
